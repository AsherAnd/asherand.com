...
export default function Home() {
  ...
  const scrollTo = contextSafe(()=>{
    gsap.to(window, { duration: 0.25, scrollTo: {y: "#contact", offsetY:112 }});
  })
    ...
    <div id="home" className="container">
      <div className="intro">
        ...
        <div className="intro-welcome">
          ...
          <p>Welcome to my personal website. Feel free to look around and contact me for any service inquiries.</p>
